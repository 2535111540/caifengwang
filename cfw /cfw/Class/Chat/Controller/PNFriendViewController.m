//
//  PNFriendViewController.m
//  cfw
//
//  Created by majun on 16/10/31.
...
@interface PNFriendViewController ()<UITableViewDelegate,UITableViewDataSource>
{
...
@implementation PNFriendViewController
